"""
Phishing Email Templates for PhishGuard.

These templates represent standard social engineering attack vectors (Urgency, Authority, Fear of Loss)
for authorized security assessment and awareness testing.
All templates contain mandatory security simulation disclaimer footers.
"""
...
TEMPLATES: Dict[str, Dict[str, Any]] = {
    "nordvault-security": {
        ...
        "difficulty": "Medium",
        "subject": "🚨 SECURITY SIMULATION - DO NOT CLICK OR ENTER CREDENTIALS",
...
<body style="margin: 0; padding: 0; background-color: #0b0f19; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #e2e8f0;">
    <!-- 🚨 CRITICAL SECURITY SIMULATION BANNER -->
    <div style="background-color: #7f1d1d; border-bottom: 3px solid #ef4444; padding: 14px 20px; text-align: center; font-size: 13px; color: #fecaca;">
        <span style="font-size: 16px;">🚨</span> <strong style="color: #fca5a5;">SECURITY SIMULATION — DO NOT ENTER CREDENTIALS</strong><br>
        <span style="color: #fecaca; font-size: 11px;">Do NOT click this link. Do NOT enter any passwords. This is a controlled phishing simulation.</span>
    </div>
    ...
    <div style="max-width: 580px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5);">
        ...
        <!-- Security Simulation Disclaimer Footer -->
        <div style="background-color: #7f1d1d; padding: 20px 32px; border-top: 3px solid #ef4444; font-size: 12px; color: #fecaca; line-height: 1.6;">
            <strong style="color: #fca5a5; font-size: 14px;">🔒 PHISHGUARD SECURITY SIMULATION</strong><br><br>
            <strong style="color: #ffffff;">DO NOT CLICK THE LINK ABOVE. DO NOT ENTER ANY PASSWORDS.</strong><br><br>
            This email is a simulated phishing attack created by <strong>PhishGuard</strong> for authorized security awareness assessment.
            If you click the link and enter credentials, they will be captured in real-time to demonstrate how credential harvesting attacks work.
            <br><br>
        ...
        "generate_text": lambda target_email, sim_url: f"""[PhishGuard Security Simulation]
=========================================
...
---
NOTICE: This is a security awareness simulation generated by PhishGuard. Do not enter real credentials.
"""
    },
    ...
    "storage-quota": {
        ...
        "difficulty": "Easy",
        "subject": "⚠️ SECURITY SIMULATION - Storage Alert - Cloud Storage Exceeded",
...
<body style="margin: 0; padding: 0; background-color: #0f172a; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #e2e8f0;">
    <!-- Security Simulation Top Banner -->
    <div style="background-color: #1e293b; border-bottom: 1px solid #334155; padding: 10px 16px; text-align: center; font-size: 12px; color: #94a3b8;">
        🛡️ <strong style="color: #38bdf8;">PhishGuard Security Simulation</strong> &mdash; This is an authorized security awareness training exercise.
    </div>
    ...
    <div style="max-width: 580px; margin: 30px auto; background-color: #1e293b; border: 1px solid #334155; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5);">
        ...
        <div style="background-color: #0f172a; padding: 18px 32px; border-top: 1px solid #334155; font-size: 11px; color: #64748b; line-height: 1.5;">
            <strong style="color: #94a3b8;">🔒 Security Simulation Notice:</strong><br>
            This email is an authorized security test from <strong>PhishGuard</strong>. It models artificial quota urgency. Never submit authentic credentials on unverified third-party pages.
        </div>
    </div>
</body>
</html>""",
...
"""
    ...
    "hr-policy-update": {
        ...
        "difficulty": "Hard",
        "subject": "⚠️ SECURITY SIMULATION - Mandatory HR Policy Review",
...
<body style="margin: 0; padding: 0; background-color: #0b0f19; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #e2e8f0;">
    ...
    <div style="max-width: 580px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5);">
        ...
        <div style="background-color: #030712; padding: 18px 32px; border-top: 1px solid #1f2937; font-size: 11px; color: #64748b; line-height: 1.5;">
            <strong style="color: #94a3b8;">🔒 Security Simulation Notice:</strong><br>
            This simulation is generated by <strong>PhishGuard</strong> to assess awareness of authority-based compliance impersonation attacks.
        </div>
    </div>
</body>
</html>""",
...
---
NOTICE: This is an security awareness simulation generated by PhishGuard. Do not enter real credentials.
"""
    }
}
